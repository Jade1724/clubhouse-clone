...
export default function Welcome() {
    return <div className={style.WelcomeContainer}>
        ...
        <div className={style.WelcomeInfo}>
            ...
            <p>Anyone can join with an invite from an existing user - or reserve your username and we'll text you if you have a friend on the app who can let you in. We are so grateful you're heare and can't wait to have you join!</p>
